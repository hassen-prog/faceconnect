                    ...
                    <div class="card d-flex w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                        <div class="card-body p-0 d-flex">
                            <figure class="avatar me-3">
                                <img src="{{ asset('images/' . $post->profile->profile_picture) }}" alt="avater"
                                    class=" round_img_m shadow-sm rounded-circle w45" />
                            </figure>
                            ...
                            <div class="row ps-2 pe-2">
                                @if ($post->image)
                                    <div class="col-sm-12 p-1">
                                        <img src="{{ asset('images/' . $post->image) }}" alt="avater"
                                            class="rounded-3 w-100" alt="post" />
                                    </div>
                                @endif
                            </div>
                        </div>
