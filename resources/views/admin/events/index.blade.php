                            ...
                            <h2 class="fw-700 mb-0 mt-0 font-md text-grey-900 d-flex align-items-center">Events
                                <form action="{{ route('admin.events.index') }}" method="GET" class="pt-0 pb-0 ms-auto">
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <a class="btn btn-primary mx-2" href="/admin/events/create">Create Event As
                                            Admin</a>
                                    </div>
                        ...
                        <tbody>
                            @foreach ($events as $event)
                                <tr>
                                    ...
                                    <th>
                                        <div><img src="{{ asset('images/events/' . $event->image_path) }}" alt="avater"
                                                class="shadow-sm mt-2 w40 " /></div>
                                    </th>
                                    <td><a
                                            href="{{ route('admin.events.show', ['event' => $event->id]) }}">{{ $event->title }}</a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between" style="min-width: 100px">
                                            <a href="{{ route('admin.events.edit', $event->id) }}" class="text-white">
