                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <div
                                    ...
                                    <h2 class="display2-size display2-md-size fw-700 text-white mb-0 mt-0"> Edit Event
                                ...
                                <div class="page-title">
                                    ...
                                    <form method="POST" action="{{ route('events.update', $event->id) }}"
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <div class="form-gorup">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control"
                                                        placeholder="Event Name" value="{{ $event->title }}">
                                                    @error('title')
                                                ...
                                                <div class="form-gorup">
                                                    <div class="form-floating">
                                                        <textarea class="form-control" name="description" id="description" placeholder="What are the details?"
                                                            style="height: 100px">{{ $event->description }}</textarea>
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <div class="form-gorup">
                                                    ...
                                                    <input type="number" name="max_participants" id="max_participants"
                                                        class="form-control" value="{{ $event->max_participants }}">
                                                </div>
                                        ...
                                        <div class="mx-auto d-flex justify-content-center mt-4">
                                            <button class="btn btn-primary p-3 mx-auto" style="font-size: 1.3rem ">Save
                                                Event</button>
                                        </div>
                                    </form>
