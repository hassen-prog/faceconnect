...
<div class="main-content right-chat-active">
    <div class="middle-sidebar-bottom">
        <div class="middle-sidebar-left pe-0" style="max-Width: 100%">
            <div class="row">
                <div class="col-lg-12 position-relative">
                            ...
                            <div class="messages-content pb-5">
                                ...
                                <div class="message-item outgoing-message">
                                    <div class="message-user">
                                        ...
                                        <div>
                                            <h5>Byrom Guittet</h5>
                                            <div class="time">01:35 PM<i
                                                class="ti-double-check text-info"></i></div>
                                        </div>
                                    </div>
                                    <div class="message-wrap">I want those files for you. I want you to
                                ...
                                <div class="message-item">
                                    ...
                                    <div class="message-wrap">I've found some cool photos for our travel
                                        app.
                                    </div>
                                </div>
                                ...
                                <div class="message-item">
                                    ...
                                    <figure>
                                        <img src="assets/images/product.png"
                                             class="w-25 img-fluid rounded-3" alt="avater"/>
                                    </figure>
                                ...
                                <div class="message-item outgoing-message">
                                    ...
                                    <div class="message-wrap" style="margin-Bottom: 90px">Hey mate!
                    ...
                    <div class="chat-bottom dark-bg p-3 shadow-none theme-dark-bg"
                        ...
                        <form class="chat-form">
                            ...
                            <button class="bg-current"><i class="ti-arrow-right text-white"></i>
                            </button>
                        </form>
                    </div>
                </div>
