                        ...
                        <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                            <form action="{{ route('profile.update' , $profile->id) }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="town" id="town" class="form-control" value="{{ $profile->town }}" />
                                            @error('town')
                                            <span class="text-danger">{{ $message }}</span>
                                           @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="postcode" id="postcode" class="form-control" value="{{ $profile->postcode }}" />
                                            @error('postcode')
                                            <span class="text-danger">{{ $message }}</span>
                                           @enderror
                                        </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5"  value="{{ $profile->description }}"></textarea>
                                </div>
                            ...
                            <form action="{{ route('profile.destroy', $profile->id) }}" method="POST" class="d-flex">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" style="margin-left: 580px;">Delete Profile </button>
                            </form>
